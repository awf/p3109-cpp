...
struct TestProjectOps {
  ...
  static bool test_saturate_finite()
  {
    ...
    const auto z =
      p3109::Saturate<Sigma, Delta, p3109::SatFinite, p3109::NearestTiesToEven>(p3109::mpfr_inf(), max_finite);
  ...
  static bool test_saturate_propagate()
  {
    const auto max_finite = p3109::Decode(float_type{p3109::pow2_u64(K - 1) - 2});
    const auto z =
      p3109::Saturate<Sigma, Delta, p3109::SatPropagate, p3109::NearestTiesToEven>(p3109::mpfr_inf(), max_finite);
  ...
  {
    const auto max_finite = p3109::Decode(float_type{p3109::pow2_u64(K - 1) - 2});
    const auto z = p3109::Saturate<Sigma, Delta, p3109::OvfInf, p3109::TowardZero>(max_finite * 2, max_finite);
  ...
  {
    const auto max_finite = p3109::Decode(float_type{p3109::pow2_u64(K - 1) - 2});
    const auto z = p3109::Saturate<Sigma, Delta, p3109::OvfInf, p3109::NearestTiesToEven>(max_finite * 2, max_finite);
  ...
  static bool test_project_nan()
  {
    ...
    using PS = p3109::ProjectionSpec<p3109::NearestTiesToEven, p3109::SatFinite>;
    const auto z = p3109::Project<Format>(p3109::mpfr_nan(), PS{});
  ...
  {
    using Format = p3109::binary<K, P, Sigma, Delta>;
    using PS = p3109::ProjectionSpec<p3109::NearestTiesToEven, p3109::OvfInf>;
    const auto z = p3109::Project<Format>(p3109::mpfr_float("1e100"), PS{});
    return test_utils::expect_true(
  ...
  {
    using Format = p3109::binary<K, P, Sigma, Delta>;
    using PS = p3109::ProjectionSpec<p3109::TowardZero, p3109::OvfInf>;
    const auto z = p3109::Project<Format>(p3109::mpfr_float("1e100"), PS{});
    return test_utils::expect_true(
